...
from . import edit_delete, edit_or_reply, WWWL5, progress
...
@WWWL5.ar_cmd(pattern="زايب(?:\s|$)([\s\S]*)")
...
@WWWL5.ar_cmd(pattern="تار(?:\s|$)([\s\S]*)")
...
@WWWL5.ar_cmd(pattern="ان زايب(?:\s|$)([\s\S]*)")
async def zip_file(event):
...
@WWWL5.ar_cmd(pattern="ان تار(?:\s|$)([\s\S]*)")
