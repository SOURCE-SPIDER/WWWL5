...
from . import WWWL5, song_download
...
@WWWL5.ar_cmd(pattern="بحث(320)?(?:\s|$)([\s\S]*)")
...
@WWWL5.ar_cmd(pattern="فيديو(?:\s|$)([\s\S]*)")
...
@WWWL5.ar_cmd(pattern="(ا(ل)?ا(س)?م)(?:\s|$)([\s\S]*)")
    ...
    if flag == "s":
        ...
        async with event.client.conversation(chat) as conv:
            try:
                ...
                await WWWL5(unblock("DeezerMusicBot"))
                purgeflag = await conv.send_message("/start")
