...
@WWWL5.ar_cmd(pattern="ملصق(?:\s|$)([\s\S]*)")
async def kang(args):
    photo = None
    emojibypass = False
    is_anim = False
...
@WWWL5.ar_cmd(pattern="حزمة(?:\s|$)([\s\S]*)")
...
@WWWL5.ar_cmd(pattern="تحويل بملصق(?:\s|$)([\s\S]*)")
...
@WWWL5.ar_cmd(pattern="معلومات_ألملصق$")
